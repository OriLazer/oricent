...
itemSalesSearchTableCreatorFile = 'model/item/itemSalesSearchTableCreator.php';


// File that creates the item details search table
itemCategorySearchTableCreatorFile = 'model/item/itemCategorySearchTableCreator.php';

// File that creates the item details search table
itemPriceSearchTableCreatorFile = 'model/item/itemPriceSearchTableCreator.php';

// File that creates the item details search table
itemInventorySearchTableCreatorFile = 'model/item/itemInventorySearchTableCreator.php';

// File that creates the item details search table
itemCustomerSearchTableCreatorFile = 'model/item/itemCustomerSearchTableCreator.php';

// File that creates the item details search table
itemPurchaseSearchTableCreatorFile = 'model/item/itemPurchaseSearchTableCreator.php';


// File that creates the item details search table
itemWeekInventSearchTableCreatorFile = 'model/item/itemWeekInventSearchTableCreator.php';


// File that creates the item details search table
itemTypeSearchTableCreatorFile = 'model/item/itemTypeSearchTableCreator.php';
...
lowStockReportsSearchTableCreatorFile = 'model/item/lowStockReportsSearchTableCreator.php';
...
saleItemFilteredReportCreatorFile = 'model/sale/saleItemFilteredReportTableCreator.php';

// File that creates the filtered sale report table
saleFilteredReportCreatorFile = 'model/sale/saleFilteredReportTableCreator.php';

// File that creates the filtered sale report table
saleSumFilteredReportCreatorFile = 'model/sale/saleSumFilteredReportTableCreator.php';
...
$(document).ready(function(){
	...
	// Listen to Item Select
	$('#purchasedItemDetail').on('change', function(){
		var itemid = $('#purchasedItemDetail option:selected').val()
		getItemDetailsToPop(itemid);
	});
	...
	$(document).on('click', '#purchaseDetailsItemNumberSuggestionsList li', function(){
		...
		getItemStockToPopulate('purchasedItemDetail', getItemStockFile, 'purchaseDetailsCurrentStock');
	});
	...
	searchTableCreator('itemSalesTableDiv', itemSalesSearchTableCreatorFile, 'itemSalesTable');
	searchTableCreator('itemCustomerTableDiv', itemCustomerSearchTableCreatorFile, 'itemCustomerTable');
	searchTableCreator('itemWeekInventTableDiv', itemWeekInventSearchTableCreatorFile, 'itemWeekInventTable');
	searchTableCreator('itemInventoryTableDiv', itemInventorySearchTableCreatorFile, 'itemInventoryTable');
	searchTableCreator('itemPriceTableDiv', itemPriceSearchTableCreatorFile, 'itemPriceTable');
	searchTableCreator('itemTypeTableDiv', itemTypeSearchTableCreatorFile, 'itemTypeTable');
	searchTableCreator('itemCategoryTableDiv', itemCategorySearchTableCreatorFile, 'itemCategoryTable');
	searchTableCreator('itemPurchaseTableDiv', itemPurchaseSearchTableCreatorFile, 'itemPurchaseTable');
	...
	reportsTableCreator('lowStockReportsTableDiv', lowStockReportsSearchTableCreatorFile, 'lowStockReportsTable');
	reportsSaleTableCreator('saleReportsTableDiv', saleReportsSearchTableCreatorFile, 'saleReportsTable');
	...
	$( '#itemTypeTablesRefresh').on('click', function(){
		searchTableCreator('itemTypeTableDiv', itemTypeSearchTableCreatorFile, 'itemTypeTable');
	});

	// Listen to refresh buttons
	$( '#itemCategoryTablesRefresh').on('click', function(){
		searchTableCreator('itemCategoryTableDiv', itemCategorySearchTableCreatorFile, 'itemCategoryTable');
	});

	// Listen to refresh buttons
	$( '#itemDetailsTablesRefresh').on('click', function(){
		searchTableCreator('itemDetailsTableDiv', itemDetailsSearchTableCreatorFile, 'itemDetailsTable');
		// var id = document.getElementById("itemform");
		resetForm('itemform');
	});
	...
	// Listen to refresh buttons
	$( '#itemPriceTablesRefresh').on('click', function(){
		searchTableCreator('itemPriceTableDiv', itemPriceSearchTableCreatorFile, 'itemPriceTable');
	});

	// Listen to refresh buttons
	$( '#stockInventoryTablesRefresh').on('click', function(){
		searchTableCreator('itemInventoryTableDiv', itemInventorySearchTableCreatorFile, 'itemInventoryTable');
	});

	// Listen to refresh buttons
	$( '#weekInventoryTablesRefresh').on('click', function(){
		searchTableCreator('itemWeekInventTableDiv', itemWeekInventSearchTableCreatorFile, 'itemWeekInventTable');
	});

	// Listen to refresh buttons
	$( '#salesDetailTablesRefresh').on('click', function(){
		searchTableCreator('itemPurchaseTableDiv', itemPurchaseSearchTableCreatorFile, 'itemPurchaseTable');
	});

	// Listen to refresh buttons
	$( '#salesSummaryTablesRefresh').on('click', function(){
		searchTableCreator('itemSalesTableDiv', itemSalesSearchTableCreatorFile, 'itemSalesTable');
	});

	// Listen to refresh buttons
	$( '#customerTablesRefresh').on('click', function(){
		searchTableCreator('itemCustomerTableDiv', itemCustomerSearchTableCreatorFile, 'itemCustomerTable');
	});
	...
	$('#showItemSaleReport').on('click', function(){
		filteredSaleReportTableCreator('saleItemReportStartDate', 'saleItemReportEndDate', saleItemFilteredReportCreatorFile, 'saleItemReportsTableDiv', 'saleItemFilteredReportsTable');
	});
	...
	// Listen to sale report show button
	$('#showSumSaleReport').on('click', function(){
		filteredSaleReportTableCreator('saleSumReportStartDate', 'saleSumReportEndDate', saleSumFilteredReportCreatorFile, 'saleSumReportsTableDiv', 'saleSumFilteredReportsTable');
	});
		...
		complete: function(){
			...
			$('#' + tableID).DataTable({
				...
				buttons: [
					...
					{extend: 'csv', footer: true, title: 'Sale Report'},
					{extend: 'excel', footer: true, title: 'Sale Report'},
					{extend: 'pdf', footer: true, orientation: 'landscape', pageSize: 'A4', title: 'Sale Report'},
					{extend: 'print', footer: true, title: 'Sale Report'},
				]
			});
		}
...
function addCustomer() {
	...
	var customerDetailsStatus = $('#customerDetailsStatus option:selected').val();
...
function addItem() {
	...
	var itemType = $('#itemeType option:selected').val();
	var itemCategory = $('#itemeCategory option:selected').val();
...
function addInventory() {
	var itemInventid = $('#itemInventid option:selected').val();
	var InventQuantity = $('#InventQuantity').val();
	
	$.ajax({
		url: 'model/item/insertInvent.php',
		method: 'POST',
		data: {
			itemInventid:itemInventid,
			InventQuantity:InventQuantity
		},
		success: function(data){
			$('#itemInventorykMessage').fadeIn();
			$('#itemInventorykMessage').html(data);
			setTimeout(function() {
				$("#inventid").remove();
...
// Function to call the insertItem.php script to insert item data to db
function addStock() {
	var itemstockid = $('#itemstockid option:selected').val();
	var stockquantity = $('#stockQuantity').val();
	var packQuantity = $('#packQuantity').val();
	var threshold = $('#threshold').val();
	
	$.ajax({
		url: 'model/item/insertStock.php',
		method: 'POST',
		data: {
		...
		success: function(data){
			$('#itemStockMessage').fadeIn();
			$('#itemStockMessage').html(data);
			setTimeout(function() {
				$("#stockid").remove();
...
// Function to call the insertItem.php script to insert item data to db
function addPrice() {
	var itemId = $('#itempriceid option:selected').val();
	var itemPrice = $('#itemePrice').val();
	
	$.ajax({
		url: 'model/item/insertPrice.php',
		method: 'POST',
		data: {
			itemId:itemId,
			itemPrice:itemPrice
		...
		success: function(data){
			$('#itemPriceMessage').fadeIn();
			$('#itemPriceMessage').html(data);
			setTimeout(function() {
				$("#priceid").remove();
...
function addCategory() {
	...
	$.ajax({
		url: 'model/item/insertCategory.php',
		method: 'POST',
		data: {
			itemCategory:itemCategory
		},
		success: function(data){
			$('#itemCategoryMessage').fadeIn();
			$('#itemCategoryMessage').html(data);
			setTimeout(function() {
				$("#catoid").remove();
...
// Function to call the insertItem.php script to insert item data to db
function addType() {
	var itemDetailsItemName = $('#itemType').val();
	
	$.ajax({
		url: 'model/item/insertType.php',
		method: 'POST',
		data: {
			itemDetailsItemName:itemDetailsItemName
		},
		success: function(data){
			$('#itemTypeMessage').fadeIn();
			$('#itemTypeMessage').html(data);
			setTimeout(function() {
				$("#typeid").remove();
...
function addPurchase() {
	...
	$.ajax({
		...
		success: function(data){
			...
			// var table=('#itemPurchase').Datatable();
			// table.destroy();
			// table.draw();
			// $('#itemPurchase').ajax.reload();
		},
		complete: function(){
			getItemStockToPopulate('purchaseDetailsItem', getItemStockFile, 'purchaseDetailsCurrentStock');
...
function getItemDetailsToPop(itemid){
	// Get the itemNumber entered in the text box
	var itemNumber = itemid;
	...
	$.ajax({
		...
		dataType: 'json',
		success: function(data){
			$('#purchaseDetailsCurrentStock').val(data.availableStock);
			$('#purchaseDetailsUnitPrice').val(data.price);
		}
	});
}
...
function getItemStockToPopulate(itemNumberTextbox, scriptPath, stockTextbox){
	...
	$.ajax({
		...
		dataType: 'json',
		success: function(data){
			$('#' + stockTextbox).val(data.availableStock);
		},
		error: function (xhr, ajaxOptions, thrownError) {
        //alert(xhr.status);
        //alert(thrownError);
